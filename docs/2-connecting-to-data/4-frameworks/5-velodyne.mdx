...
To test your connection, add a [3D panel](/docs/visualization/panels/3d) to your layout, and open your panel settings to toggle on the velodyne topic. You should now see an interactive representation of your Lidar scan in a 3D scene.

## Links and resources

- [Open a Velodyne LIDAR connection](https://foxglove.dev/blog/opening-a-velodyne-lidar-connection)
