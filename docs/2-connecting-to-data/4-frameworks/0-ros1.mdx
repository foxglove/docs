...
Load local and remote [ROS 1](https://foxglove.dev/blog/installing-ros1-on-ubuntu) (`.bag`) files, or connect directly to a live ROS 1 stack.
...
Once you have a working [ROS 1](https://foxglove.dev/blog/installing-ros1-on-ubuntu) setup on your computer, run `roscore` in your terminal to start your ROS master.
