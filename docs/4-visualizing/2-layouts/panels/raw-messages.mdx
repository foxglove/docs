export const meta = {
  title: "Raw Messages",
  description: "Display incoming topic data in an easy-to-read collapsible tree format.",
  heroImage: "/img/docs/studio/panels/raw-messages/panel.webp",
};

> Display incoming topic data in an easy-to-read collapsible tree format.
