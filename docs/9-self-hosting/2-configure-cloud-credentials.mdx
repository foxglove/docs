...
export const meta = {
  title: "Configure cloud credentials",
  description:
    "Self-managed Primary Sites need additional cloud credentials to import data from its corresponding Edge Sites.",
};

Self-managed Primary Sites need additional cloud credentials to import data from its corresponding Edge Sites.

Use the instructions below to configure your Primary Site cloud credentials, then [Continue installation](installation#install-the-release).
