...
The Foxglove window that opens with your Data Platform data source will display a bookmark icon on the playback bar.
...
When streaming data from Foxglove Data Platform, Foxglove’s playback bar will display events using blue bars. Hovering on a blue bar will display its metadata in a tooltip.
