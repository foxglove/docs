...
export const meta = {
  title: "Shortcuts",
  description: "Use keyboard shortcuts to quickly navigate the Foxglove Studio interface.",
  heroImage: "/img/docs/studio/app-concepts/playback/bar.webp",
};

> Use keyboard shortcuts to quickly navigate the Foxglove Studio interface.
