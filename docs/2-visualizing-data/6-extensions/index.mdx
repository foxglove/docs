...
export const meta = {
  ...
  description:
    "Extend Foxglove Studio using the @foxglove/studio SDK and create-foxglove-extension.",
};
...
Topic alias extensions allow you to alias topics in your data source to new topics. Foxglove Studio panels can subscribe to both the aliased topics and the original data source's topics.
