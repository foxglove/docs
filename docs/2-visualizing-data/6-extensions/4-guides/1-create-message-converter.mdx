...
Once we've packaged and installed our extension, load any data source containing `sensors.MyGps` messages in Foxglove and visualize them with the [Map panel](/docs/studio/panels/map).
