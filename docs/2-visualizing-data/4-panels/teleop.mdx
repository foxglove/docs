export const meta = {
  title: "Teleop",
  description:
    "Teleoperate your robot using geometry_msgs/Twist messages on a given topic back to your live ROS stack.",
  heroImage: "/img/docs/studio/panels/teleop/panel.webp",
};
