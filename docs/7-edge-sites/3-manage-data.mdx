...
Once your edge site is [installed and running](installation), you can start processing data through the site.
...
Once successfully uploaded to your edge site, your recording will appear on the Foxglove web console's [_Recordings_ page](https://console.foxglove.dev/recordings) and be available via the recordings API endpoint.
