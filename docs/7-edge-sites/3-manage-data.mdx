...
Once successfully uploaded to your edge site, your recording will appear on the [Recordings page](https://console.foxglove.dev/recordings) and be available via the recordings API endpoint.

### Import to cloud

To access data from your edge site, you must first import it to your Primary Site in the cloud.

Queue import for any edge recording using the Foxglove API or the [Recordings page](https://console.foxglove.dev/recordings). The edge site will process this queue using available bandwidth resources.
