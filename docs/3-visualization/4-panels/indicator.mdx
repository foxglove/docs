...
![indicator panel](/img/docs/visualization/panels/indicator/panel.webp)
...
| field          | description                                                                                      |
| --------- | ------------------------------------------------------------------------------------------------- |
| **Data**  | [Message path](/docs/visualization/message-path-syntax) to the data value you want to track |
