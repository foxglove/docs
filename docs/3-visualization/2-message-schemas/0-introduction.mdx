...
If you've already written custom messages, you can transform them into Foxglove-supported schemas using a [message converter](/docs/visualization/extensions/getting-started#message-converters) extension.
