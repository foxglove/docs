---
title: CORS setup
description: To load remote data files into Foxglove, you must host your files in a server or cloud provider that supports Cross-Origin Resource Sharing (CORS) and accepts range requests.
---

To load remote data files into Foxglove, you must host your files in a server or cloud provider that supports Cross-Origin Resource Sharing (CORS) and accepts range requests.
