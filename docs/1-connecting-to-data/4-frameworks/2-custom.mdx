---
title: Custom
description: Foxglove can load local and remote MCAP files containing custom data (i.e. Protobuf, JSON, FlatBuffers), or connect directly to live custom data via a Foxglove WebSocket connection.
---
...
Foxglove can load local or remote [MCAP](https://mcap.dev) files containing custom data (i.e. [Protobuf](https://developers.google.com/protocol-buffers), [JSON](http://jsonschema.org/), [FlatBuffers](https://google.github.io/flatbuffers)), or connect directly to live custom data via a Foxglove WebSocket connection.
...
Once converting yoru custom data to MCAP files and uploading them to Foxglove, you can stream them directly for visualization.
