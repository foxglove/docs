...
Once you've [recorded your custom data to MCAP (`.mcap`) files](/docs/studio/connection/custom#local-file), you can upload them to [Foxglove Data Platform](/data-platform)'s [web console](https://console.foxglove.dev) and stream them directly into Foxglove.
