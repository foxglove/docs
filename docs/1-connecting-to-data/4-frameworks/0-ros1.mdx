...
This option requires running an extra ROS node ([`foxglove_bridge`](https://index.ros.org/p/foxglove_bridge/)) – follow the [installation directions here](/connecting-to-data/foxglove-bridge).

#### Connect

[Set up the Foxglove bridge](/connecting-to-data/ros-foxglove-bridge).
