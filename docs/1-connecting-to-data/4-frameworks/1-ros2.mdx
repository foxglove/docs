...
[Set up the Foxglove bridge](/docs/studio/connection/using-foxglove-bridge).
...
Once you [convert your ROS 2 `.db3` files to MCAP (`.mcap`) files](/docs/studio/connection/ros2#files), you can upload them to [Foxglove](https://console.foxglove.dev) and stream them directly for visualization.
