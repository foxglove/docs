...
export const meta = {
  title: "Variables",
  description:
    "Variables are values that can be set globally for a given layout, and can be used to quickly switch between subsets of your data.",
  heroImage: "/img/docs/studio/app-concepts/variables/menu.webp",
};
