...
Once you've developed and installed your extension, you can open your [app settings](/visualizing/introduction#settings#extensions) to display all available and installed extensions.
...
For example, an extension could convert your custom GPS message into a [`foxglove.LocationFix`](/visualizing/supported-messages/location-fix) message to be displayed within the [Map panel](/visualization/panels/map).
