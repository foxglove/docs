---
title: Introduction
description: Adhering to Foxglove-supported schemas will help you take full advantage of the platform's built-in visualizations.
---

[Foxglove panels](TBD) often require incoming messages to conform to a known schema to visualize them properly,

Adhering to Foxglove-supported schemas will help you take full advantage of the platform's built-in visualizations.
...
If you've already written custom messages, you can transform them into Foxglove-supported schemas using a [message converter](/docs/studio/extensions/getting-started#message-converters) extension.
