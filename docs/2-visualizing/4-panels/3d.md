...
| Custom    | [`foxglove.Grid`](/visualizing/supported-messages/grid)                                                                        |
...
| Custom    | [`foxglove.LaserScan`](/visualizing/supported-messages/laser-scan)                                                           |
...
| Custom    | [`foxglove.PosesInFrame`](/visualizing/supported-messages/poses-in-frame)                                    |
...
| Custom    | [`foxglove.PointCloud`](/visualizing/supported-messages/point-cloud)                                                             |
...
| framework | schema                                                       |
| --------- | ------------------------------------------------------------ |
| Custom    | [`foxglove.SceneEntity`](/visualizing/supported-messages/scene-entity) |
| Custom    | [`foxglove.SceneUpdate`](/visualizing/supported-messages/scene-update) |
...
| Custom    | [`foxglove.FrameTransform`](/visualizing/supported-messages/frame-transform)                                 |

### Velodyne scan

Velodyne Lidar scan packets from the Velodyne ROS driver or the Foxglove desktop app's [Velodyne connection](/connecting-to-data/velodyne).
...
| **Topic** | Topic to publish message to – only possible with a [ROS data source with publish support](/connecting-to-data/live-data#limitations).                                                                                                                                                                                  |
