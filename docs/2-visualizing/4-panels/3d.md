...
Velodyne Lidar scan packets from the Velodyne ROS driver or the Foxglove desktop app's [Velodyne connection](/docs/studio/connection/velodyne).
...
Lists topics that match a supported [visualization](#visualizations) and can be displayed in the scene. Toggle individual topics.
