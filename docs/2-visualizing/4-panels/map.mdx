...
![map panel](/img/docs/visualizing/panels/map/panel.webp)
...
| Custom    | [`foxglove.LocationFix`](/docs/visualizing/supported-messages/location-fix)                                                       |

### `GeoJSON`

| framework | schema                                               |
| --------- | ---------------------------------------------------- |
| Custom    | [`foxglove.GeoJSON`](/docs/visualizing/supported-messages/geo-json) |
