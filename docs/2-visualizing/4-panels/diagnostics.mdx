...
![diagnostics summary panel](/img/docs/visualizing/panels/diagnostics/summary-panel.webp)

To pin a node to the top of your feed, hover on an entry and click the pin icon that appears.

![pin diagnostic](/img/docs/visualizing/panels/diagnostics/pin.webp)

Use the dropdown menu to select the minimum level by which you want to filter your diagnostics.

![filter by level](/img/docs/visualizing/panels/diagnostics/level.webp)
...
![diagnostics summary search](/img/docs/visualizing/panels/diagnostics/search.webp)
...
![diagnostics summary and detail panels](/img/docs/visualizing/panels/diagnostics/with-detail-panel.webp)
