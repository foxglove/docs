...
![image panel](/img/docs/visualizing/panels/image/panel.jpeg)
...
![download as png](/img/docs/visualizing/panels/image/download.webp)

Click any displayed image marker to view its details.

![marker details](/img/docs/visualizing/panels/image/marker-details.webp)
...
_NOTE: Foxglove currently only supports `plumb_bob` and `rational_polynomial` for the `distortion_model` field value._
