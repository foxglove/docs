export const meta = {
  ...
  heroImage: "/img/docs/studio/panels/indicator/panel.webp",
};

> Display a color-coded label to indicate threshold values in your data.

![indicator panel](/img/docs/studio/panels/indicator/panel.webp)

## Settings

| General   |                                                                                                   |
| --------- | ------------------------------------------------------------------------------------------------- |
| **Data**  | [Message path](/docs/studio/app-concepts/message-path-syntax) to the data value you want to track |
