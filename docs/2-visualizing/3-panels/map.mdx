export const meta = {
  title: "Map",
  description: "Display points on a world map, using topics that contain LocationFix messages.",
  heroImage: "/img/docs/studio/panels/map/panel.webp",
};

> Display points on a world map, using topics that contain [`LocationFix`](#locationfix) messages.
