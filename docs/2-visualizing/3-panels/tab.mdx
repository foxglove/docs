export const meta = {
  title: "Tab",
  description: "Group related panels into tabs to organize your layout and save space.",
  heroImage: "/img/docs/studio/panels/tab/selection.webp",
};
...
<div className="relative h-0" style={{ paddingBottom: "55%" }}>
  <iframe
    ...
    title="YouTube video player – Using the Tab Panel in Foxglove Studio"
    frameBorder="0"
