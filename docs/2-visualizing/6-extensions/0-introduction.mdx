...
Once you've developed and installed your extension, you can open your [app settings](/docs/visualizing/introduction#settings#extensions) to display all available and installed extensions.
...
For example, an extension could convert your custom GPS message into a [`foxglove.LocationFix`](/docs/visualizing/supported-messages/location-fix) message to be displayed within the [Map panel](/docs/visualization/panels/map).
