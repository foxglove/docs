...
Extend Foxglove using the `@foxglove/studio` SDK and `create-foxglove-extension` CLI tool.
...
The extensions API provides an interface to extending Foxglove to better support your custom workflows – whether it's by creating a custom panel or a message converter.

Once you've developed and installed your extension, you can open your [app settings](/docs/studio/app-concepts/preferences#extensions) to display all available and installed extensions.
...
- [Guide: Create custom panel](guide-create-custom-panel)
- [Build a custom panel extension (React)](/blog/building-a-custom-react-panel-with-foxglove-studio-extensions)
...
For example, an extension could convert your custom GPS message into a [`foxglove.LocationFix`](/docs/studio/messages/location-fix) message to be displayed within the [Map panel](/docs/studio/panels/map).

#### Links and resources

- [Guide: Create message converter](guide-create-message-converter)
