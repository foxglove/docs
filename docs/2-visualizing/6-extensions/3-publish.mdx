...
Once we merge your PR, your extension will be available for anyone to install in Foxglove's [_Settings_](/docs/visualizing/introduction#settings#extensions).
