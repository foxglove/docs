...
You will see the pending import in the web console's [_Recordings_](https://console.foxglove.dev/recordings) page. Once processed, the uploaded data will be available via the API and CLI.
