...
export default function PythonIcon(props: React.SVGProps<SVGSVGElement>): ReactElement {
  // From https://github.com/Templarian/MaterialDesign/blob/master/svg/language-python.svg
  return (
    <svg
